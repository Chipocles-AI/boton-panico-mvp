...
import { notifyAdmins } from "../src/services/notifyAdmins";
...
await notifyAdmins({
  title: "🚨 ALERTA",
  body: `Nueva alerta en ${latitude.toFixed(5)}, ${longitude.toFixed(5)}\n${mapsUrl}`,
  data: { alertId, latitude, longitude, mapsUrl },
});
...
Alert.alert(
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >        
      <Text style={styles.adminLinkText}>Ir a Panel Admin</Text>
